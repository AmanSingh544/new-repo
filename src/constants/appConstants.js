...
// export const matrixListDetailed = { // remove graph for hitachi
...
// export const matrixListDetailedAccToBE = { // removed graph for hitachi
//     EMISSION_PERFORMANCE: "1",
//     LANES_EMISSIONS: "2",
//     COST_FUEL: "3",
//     MODES_EMISSIONS: "4", //"5"
//     TOTAL_SCOPE_3_EMISSION_VS_CATEGORIES: "5", //"8",    
//     BU_PERFORMANCE: "6", //36",   
//     EMISSION_BY_COUNTRY: "7", //34",
//     CONTINENT_EMISSIONS: "8", //35",
//   }

// export const allMatrixArr = [
//    // remove graph for hitachi
...
// export const allGraphDetailedSummary = [ // remove graph for hitachi
...
// export const colorArrayGraphs = ["#B1000E", "#B3B3B3", "#D05761", "#1C2325", "#E8999F"];
//                               //["#555f63", "#1078A8", "#b1000e", "#00183F", "#00A0CA"];
...
/*
export const GraphNames = {
  "EMISSION_BY_REGION_DETAILED": "Emission By Region Detailed",
  "EMISSION_BY_REGION": "Emission By Region",
  "EMISSION_PERFORMANCE": "Emission Performance",
  "LANES_VS_EMISSION": "Lanes Vs Emission",
  "COST_FUEL_ITEM_SHIPPED_EMISSION": "Cost-Fuel-Item Shipped-Emission",
  "MODES_VS_EMISSION": "Modes Vs Emission",
  ...
  "TOTAL_SCOPE_3_EMISSION_VS_CATEGORIES": "Total Scope-3 Emission vs Categories",
  "PROCESS_VS_EMISSIONS": "Process Vs Emissions",
  "SUPPLIER_VS_EMISSIONS": "Supplier Vs Emissions",
  ...
  "NON_SCM_SOURCING_VS_EMISSIONS": "Non SCM Sourcing Vs Emissions",
  ...
  "DEDICATED_VEHICLE_TYPE_VS_EMISSIONS": "Dedicated Vehicle Type Vs Emissions",
  "OUTSOURCED_VEHICLE_TYPE_VS_EMISSIONS": "Outsourced Vehicle Type Vs Emissions",
  "WASTE_PROCESSING_COMPANIES_VS_EMISSIONS": "Waste Processing Companies Vs Emissions",
  "SOLD_PRODUCTS_VS_EMISSIONS": "Sold Products Vs Emissions",
  "REFRIGERATION_PROCESS_VS_EMISSION": "Refrigeration Process Vs Emission",
  ...
  "SPEND_VS_EMISSION": "Spend Vs Emission",
  "PURCHASED_ELECTRICITY_CONSUMPTION_VS_EMISSION": "Purchased Electricity Consumption Vs Emission",
  "INVESTMENT_COMPANY_BASED_EMISSION": "Investment Company based Emission",
  "EXTRACTION_PRODUCTION_TRANSMISSION_VS_EMISSION": "Extraction,Production,Transmission Vs Emission",
  "PRODUCT_TYPE_VS_EMISSIONS": "Product Type Vs Emissions",
  "BUSINESS_TRAVEL_VS_EMMISSION": "Business Travel Vs Emmission",
  "EMISSION_BY_COUNTRY_DETAILED": "Emission By Country",
  "EMISSION_BY_COUNTRY": "Emission By Country",
  "BU_PERFORMANCE": "BU Performance",
  "CONTINENT_VS_EMISSION": "Continent Vs Emission",
  "EMISSION_TIMELINE": "Emission Timeline",
  "EMISSION_SCOPES": "Emission Scopes",
  "EMISSION_ACROSS_ACTIVITY": "Emission Across Activity",
  "EMISSION_ACROSS_TRANSPORTATION": "Emission Across Transportation",
...
export const graphNames_new = {
  ...
  MODES_VS_EMISSION: "Modes Vs Emission",
  TOTAL_SCOPE_3_EMISSION_VS_CATEGORIES: "Total Scope 3 Emission Vs Categories",
  EMISSION_BY_COUNTRY_DETAILED: "Emission By Country Detailed",
  CONTINENT_VS_EMISSION: "Continent Vs Emission",
  BU_PERFORMANCE: "Bu Performance",
  ...
  EMISSION_ACROSS_ACTIVITY: "Emission Across Activity",
  EMISSION_ACROSS_TRANSPORTATION: "Emission Across Transportation",
  SALES_BY_EMISSION: "Sales By Emission",
  GHG_WISE_EMISSION: "Ghg Wise Emission",
  EMISSION_BY_SUPPLIER: "Emission By Supplier",
}

export const executiveSummaryDefault = [
  graphNames_new.EMISSION_TIMELINE,
  graphNames_new.EMISSION_SCOPES,
  graphNames_new.EMISSION_BY_REGION,
  graphNames_new.EMISSION_BY_COUNTRY,
  graphNames_new.EMISSION_ACROSS_ACTIVITY,
  graphNames_new.EMISSION_ACROSS_TRANSPORTATION,
  graphNames_new.SALES_BY_EMISSION,
  graphNames_new.GHG_WISE_EMISSION,
  graphNames_new.SUPPLIER_VS_EMISSIONS,
  graphNames_new.COST_FUEL_ITEM_SHIPPED_EMISSION,
  // "Emission By Region Detailed",
  // "Emission By Country Detailed",
  graphNames_new.LANES_VS_EMISSION,
  graphNames_new.PROCESS_VS_EMISSIONS,
  graphNames_new.SUPPLIER_VS_EMISSIONS,
  graphNames_new.EMISSION_PERFORMANCE,
  graphNames_new.MODES_VS_EMISSION,
  graphNames_new.TOTAL_SCOPE_1_EMISSION_VS_CATEGORIES,
  graphNames_new.TOTAL_SCOPE_2_EMISSION_VS_CATEGORIES,
  graphNames_new.TOTAL_SCOPE_3_EMISSION_VS_CATEGORIES,
  graphNames_new.UPSTREAM_NETWORKS_VS_EMISSION,
  graphNames_new.DOWNSTREAM_ASSET_TYPE_VS_EMISSION,
  graphNames_new.CONTINENT_VS_EMISSION,
];
